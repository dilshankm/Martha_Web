   ...
   //add child elemnts without attributes
	public static void addChildElement(String parent, String child,int id) {
	   ...
	   //add child elemnts without attributes but with contents
		public static void addChildElement(String parent, String child,String content,int id) {
			try {
				docBuilder = docFactory.newDocumentBuilder();
				Document doc = docBuilder.parse(xmlFile);
				Node parentNode = doc.getElementsByTagName(parent).item(id);
	...
	public static void addChildElement(String parent, String child,String attribute,String value,int id) {
		try {
			docBuilder = docFactory.newDocumentBuilder();
			Document doc = docBuilder.parse(xmlFile);
			Node parentNode = doc.getElementsByTagName(parent).item(id);
	...
	public static void addChildElement(String parent, String child,String attribute,String value,String content,int id) {
		try {
			docBuilder = docFactory.newDocumentBuilder();
			Document doc = docBuilder.parse(xmlFile);
			Node parentNode = doc.getElementsByTagName(parent).item(id);
